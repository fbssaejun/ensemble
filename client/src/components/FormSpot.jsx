...
export default function FormSpot(props) {
  ...
  return(
    <div className="form-group-spot">
      ...
      <input type="text" placeholder="Username" onChange={({ target }) => setUsername(target.value)} required/> <br/>
      <input type="text" placeholder="Instrument" onChange={({ target }) => setInstrumentId(target.value)} required/> <br/>
